...
| 2026-06-30 | [raw/2026-06-30-bold-care-glp1-weight-management-guideline.md](raw/2026-06-30-bold-care-glp1-weight-management-guideline.md) | Bold Care **GLP-1 Weight Management Guideline v1.0**, effective 2026-06-30 (CMO Dr. Sandeep Palakodeti). **Supersedes the earlier 2026-03-15 ingestion.** Full clinical protocol: indications with **Bridge ($50 copay) vs. Part D (variable cost)** coverage split (OSA/MASH as Part D triggers), BMI+WHtR triage, 65+ considerations, exclusion criteria (incl. 80+ soft-exclusion), baseline labs + STEADI + PHQ-2 + CBC + TSH, GLP-1 + AOM formulary **now including oral options (Wegovy HD, Foundayo)**, per-drug titration grids with **missed-dose rules**, mandatory protein + Bold Fitness 2x/wk, side-effect frequencies (nausea 30–50%) incl. **suspected pancreatitis**, follow-up schedule (GLP-1 Visit → prescribe via **Dosespot** + consent form), escalation chain, PCP notification template. Distilled into [[clinical-protocol]] (reconciled 2026-07-17); cross-references [[findings]] and [[principles]]. |

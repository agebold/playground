...
const PAIN_OPTIONS = [
  ...
  { value: 'free', emoji: '☺️', label: 'Pain-free' },
]

const RESPONSE_COPY = {
  bad:  "Sorry to hear that — we've swapped your class for a seated, low-impact option that's easier on your knee. Take it at your own pace today.",
  okay: "Got it — we've adjusted your class to something manageable. Listen to your body and go at your own pace.",
  free: "Love to hear it! We've lined up a great class for you. Let's make the most of your pain-free day.",
}

const STEP2_COPY = {
  locked: "Ready to get moving? Check in to unlock your move class.",
  bad:    "Here's a gentle move class to keep you going without straining your knee.",
  okay:   "Here's a manageable move class matched to how you're feeling today.",
  free:   "Time to move! Here's your class for today — enjoy the good day.",
}
...
const CLASS_CONTENT = {
  bad:  {
    ...
    why: "Since you're in some pain today, we've chosen a gentle seated class to keep you moving without straining your knee.",
  },
  okay: {
    thumbnail: classAlt2,
...
export default function Version1({ viewMode = 'mobile' }) {
          ...
          {!response ? (
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
                {PAIN_OPTIONS.map(({ value, emoji, label }) => (
                  <button key={value} onClick={() => handleResponse(value)} style={{
                    display: 'flex', flexDirection: 'column', alignItems: 'center',
                    gap: 4, padding: 12,
                    background: C.white, border: `1px solid #e5e5e5`,
                    borderRadius: 16, boxShadow: '0px 1px 3px rgba(16,24,40,0.06)',
                    cursor: 'pointer', fontFamily: 'Inter, sans-serif',
                  }}>
                    <span style={{ fontSize: 48, lineHeight: 1.1 }}>{emoji}</span>
            ...
            >
              <div style={{
                ...
                <span style={{ fontSize: 28, lineHeight: 1 }}>
                  {PAIN_OPTIONS.find(o => o.value === response)?.emoji}
                </span>

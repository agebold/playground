...
export default function PlanLoading({ onNext, selectedRegionLabel }) {
  const [visible, setVisible] = useState(0)
  const painPhrase = selectedRegionLabel ? selectedRegionLabel.toLowerCase() : 'your'

  const checks = [
    `Manage ${painPhrase} pain`,

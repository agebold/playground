...
// ─── Consent checkbox (highlighted callout, for legal acknowledgments) ───────
  ...
  return (
    <div
      ...
      style={{
        ...
        background: C.purpleLight, borderRadius: 16, padding: 12,
        cursor: 'pointer',
      }}>
      <div style={{
        width: 20, height: 20, borderRadius: 4, flexShrink: 0, marginTop: 2,
        border: `1.5px solid ${checked ? C.purple : '#acacac'}`,
      ...
      <span style={{ fontSize: 16, color: C.text, lineHeight: 1.5 }}>{children}</span>
    </div>
  )
}

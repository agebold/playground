      ...
      <div style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <div style={{ fontSize: 17, fontWeight: 600, color: '#140d26', lineHeight: '23px' }}>
            18 min Mobility: Lower Body Flow
          </div>
          <div style={{ fontSize: 15, color: '#140d26' }}>James Park</div>
        </div>
        <div style={{ background: '#ebf0ff', borderRadius: 12, padding: 12, display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <p style={{ fontSize: 15, color: '#171717', lineHeight: '22px', margin: 0 }}>
            Keep building momentum. This class complements your baseline work and eases you into regular movement.
          </p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
          <button onClick={onNext} style={{ width: '100%', padding: '12px 16px', background: C.purple, color: C.white, border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'Inter, sans-serif' }}>
            Start class
          </button>
            ...
            {showIntro && (
              <motion.div {...slideUp()} style={{ textAlign: 'center', padding: '8px 12px 0' }}>
                <p style={{ fontSize: 16, color: '#171717', lineHeight: '24px', margin: 0 }}>
                  You've completed your baseline check-in — you're all set. Now let's get moving!
                </p>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, position: 'relative', zIndex: 1 }}>
                <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                  ...
                  <div>
                    <div style={{ fontSize: 14, color: '#171717', lineHeight: '22px' }}>Completed</div>
                    <div style={{ fontSize: 16, fontWeight: 600, color: '#171717', lineHeight: '24px' }}>Baseline captured</div>
                  </div>
                </div>
              </div>

              {/* Step 2 — unlocked, class card */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, position: 'relative', zIndex: 1 }}>

...
export default function MonthlyCheckin({ onNext }) {
  ...
  const checkinOverlay = (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: C.white }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px' }}>
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Q2: activity card + previous rating */}
            {questionIndex === 1 && (
      ...
      {/* Continue button */}
      <div style={{ padding: '12px 16px 8px', background: C.white, flexShrink: 0 }}>
        <button
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden', background: '#fafafa', position: 'relative' }}>
          ...
          <AnimatePresence>
            {showGreeting && (
              <motion.div {...slideUp()} style={{ textAlign: 'center', marginTop: 4 }}>
                <div style={{ fontSize: 14, fontWeight: 600, color: '#8a8693', lineHeight: '22px' }}>Fri, Aug 14th</div>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1, paddingTop: 2 }}>
                        ...
                        <div style={{ fontSize: 16, fontWeight: 600, color: response ? '#171717' : '#8a8693', lineHeight: '24px' }}>
                          {response
                            ? "Here's your updated move class for today."
                            : 'Ready to get moving? Check in to unlock your move class.'}
                        </div>
                      </div>
                    </div>
                    <AnimatePresence>
      ...
      {/* Check-in / Complete overlay (slides in from right) */}
      <AnimatePresence>
        {overlayContent && (
          <motion.div
            initial={{ x: '100%' }}
